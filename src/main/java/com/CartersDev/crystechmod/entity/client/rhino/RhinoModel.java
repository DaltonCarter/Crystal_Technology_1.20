package com.CartersDev.crystechmod.entity.client.rhino;

import com.CartersDev.crystechmod.entity.animations.ModAnimationDefinitions;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((RhinoEntity) entity).idleAnimationState, ModAnimationDefinitions.RHINO_IDLE, 1f);
