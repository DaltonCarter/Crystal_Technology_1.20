...
import com.CartersDev.crystechmod.entity.client.LaserBeam.AdvancedLaserBeamModel;
import com.CartersDev.crystechmod.entity.client.ModModelLayers;
import com.CartersDev.crystechmod.entity.custom.AdvancedLaserBeamEntity;
...
public class AdvancedLaserBeamRenderer extends EntityRenderer<AdvancedLaserBeamEntity> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(CrystalTech.MOD_ID, "textures/entity/laser_beam.png");
    protected AdvancedLaserBeamModel model;

    public AdvancedLaserBeamRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new AdvancedLaserBeamModel(pContext.bakeLayer(ModModelLayers.ADVANCED_LASER_BEAM_LAYER));
        this.shadowRadius = 0.5F;
    }

    public void render(AdvancedLaserBeamEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
...
//        pPoseStack.translate(0.0F, 0.F, 0.0F);
    ...
    @Override
    public ResourceLocation getTextureLocation(AdvancedLaserBeamEntity pEntity) {
        return TEXTURE;
    }
