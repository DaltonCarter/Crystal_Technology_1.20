...
import com.CartersDev.crystechmod.entity.client.LaserBeam.ProtocultureLaserBeamModel;
import com.CartersDev.crystechmod.entity.client.ModModelLayers;
import com.CartersDev.crystechmod.entity.custom.ProtocultureLaserBeamEntity;
...
public class ProtocultureLaserBeamRenderer extends EntityRenderer<ProtocultureLaserBeamEntity> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(CrystalTech.MOD_ID, "textures/entity/laser_beam.png");
    protected ProtocultureLaserBeamModel model;

    public ProtocultureLaserBeamRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new ProtocultureLaserBeamModel(pContext.bakeLayer(ModModelLayers.PROTOCULTURE_LASER_BEAM_LAYER));
        this.shadowRadius = 0.5F;
    }

    public void render(ProtocultureLaserBeamEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
...
//        pPoseStack.translate(0.0F, 0.F, 0.0F);
        ...
        this.model.renderToBuffer(pPoseStack, vertexconsumer, pPackedLight, OverlayTexture.NO_OVERLAY, 1f, 1.0f, 0.0f, 1f);
        pPoseStack.popPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(ProtocultureLaserBeamEntity pEntity) {
        return TEXTURE;
    }
