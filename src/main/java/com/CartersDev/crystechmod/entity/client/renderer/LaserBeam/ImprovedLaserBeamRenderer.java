...
import com.CartersDev.crystechmod.entity.client.LaserBeam.ImprovedLaserBeamModel;
...
import com.CartersDev.crystechmod.entity.custom.ImprovedLaserBeamEntity;
...
public class ImprovedLaserBeamRenderer extends EntityRenderer<ImprovedLaserBeamEntity> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(CrystalTech.MOD_ID, "textures/entity/laser_beam.png");
    protected ImprovedLaserBeamModel model;

    public ImprovedLaserBeamRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new ImprovedLaserBeamModel(pContext.bakeLayer(ModModelLayers.IMPROVED_LASER_BEAM_LAYER));
        this.shadowRadius = 0.5F;
    }

    public void render(ImprovedLaserBeamEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
...
//        pPoseStack.translate(0.0F, 0.F, 0.0F);
        ...
        this.model.renderToBuffer(pPoseStack, vertexconsumer, pPackedLight, OverlayTexture.NO_OVERLAY, 1f, 0f, 1f, 1f);
        pPoseStack.popPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(ImprovedLaserBeamEntity pEntity) {
        return TEXTURE;
    }
