...
@OnlyIn(Dist.CLIENT)
public class EmberParticles extends TextureSheetParticle {
    ...
    protected EmberParticles(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet pSpriteSet, double v3, double v4, double v5) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
            return new EmberParticles(clientLevel, v, v1, v2, this.sprites, v3, v4, v5);
        }
