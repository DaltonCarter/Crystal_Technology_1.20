package com.CartersDev.crystechmod.screen.VitriciumRefinery.vitriciumRefineryScreen;
...
public class AlythumVitriciumRefineryScreen extends AbstractContainerScreen<AlythumVitriciumRefineryMenu> {
    ...
    public AlythumVitriciumRefineryScreen(AlythumVitriciumRefineryMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignOutputFluidRenderer() {
        ...
        outputFluidrenderer = new FluidTankRenderer(16000, true, 16, 39);
    }
