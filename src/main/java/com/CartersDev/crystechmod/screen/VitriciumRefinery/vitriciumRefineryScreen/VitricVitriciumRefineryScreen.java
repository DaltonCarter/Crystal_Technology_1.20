...
public class VitricVitriciumRefineryScreen extends AbstractContainerScreen<VitricVitriciumRefineryMenu> {
    ...
    public VitricVitriciumRefineryScreen(VitricVitriciumRefineryMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignOutputFluidRenderer() {
        ...
        outputFluidrenderer = new FluidTankRenderer(32000, true, 16, 39);
    }
