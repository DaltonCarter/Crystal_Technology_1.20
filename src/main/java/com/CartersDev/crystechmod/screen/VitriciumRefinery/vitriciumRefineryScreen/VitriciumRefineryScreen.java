...
public class VitriciumRefineryScreen extends AbstractContainerScreen<VitriciumRefineryMenu> {
    ...
    public VitriciumRefineryScreen(VitriciumRefineryMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        ...
        fluidrenderer = new FluidTankRenderer(8000, true, 16, 39);
    }

    private void assignOutputFluidRenderer() {

        outputFluidrenderer = new FluidTankRenderer(8000, true, 16, 39);
    }
