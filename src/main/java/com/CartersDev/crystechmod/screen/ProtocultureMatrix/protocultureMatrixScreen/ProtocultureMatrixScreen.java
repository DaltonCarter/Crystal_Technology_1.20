package com.CartersDev.crystechmod.screen.ProtocultureMatrix.protocultureMatrixScreen;
...
public class ProtocultureMatrixScreen extends AbstractContainerScreen<ProtocultureMatrixMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/protoculture_matrix_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;


    public ProtocultureMatrixScreen(ProtocultureMatrixMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            ...
            guiGraphics.blit(TEXTURE, x + 113, y + 12, 176, 14, k + 1, 16);
        }
    }
