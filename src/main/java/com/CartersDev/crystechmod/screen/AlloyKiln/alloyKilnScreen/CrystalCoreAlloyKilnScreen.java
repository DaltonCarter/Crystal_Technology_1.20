package com.CartersDev.crystechmod.screen.AlloyKiln.alloyKilnScreen;
...
public class CrystalCoreAlloyKilnScreen extends AbstractContainerScreen<CrystalCoreAlloyKilnMenu> {
    ...
    public CrystalCoreAlloyKilnScreen(CrystalCoreAlloyKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
