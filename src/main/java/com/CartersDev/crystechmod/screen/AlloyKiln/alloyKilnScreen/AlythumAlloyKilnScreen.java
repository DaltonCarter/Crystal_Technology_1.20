...
public class AlythumAlloyKilnScreen extends AbstractContainerScreen<AlythumAlloyKilnMenu> {
    ...
    public AlythumAlloyKilnScreen(AlythumAlloyKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
