package com.CartersDev.crystechmod.screen.StirlingMatrix.stirlingMatrixScreen;
...
public class StirlingMatrixScreen extends AbstractContainerScreen<StirlingMatrixMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/coal_matrix_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;


    public StirlingMatrixScreen(StirlingMatrixMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            ...
            guiGraphics.blit(TEXTURE,  x + 78, y + 37 + 12 - i, 176, 12 - i, 14, i + 1);

            guiGraphics.blit(TEXTURE, x + 110, y + 16, 176, 14, k + 1, 16);
        }
    }
