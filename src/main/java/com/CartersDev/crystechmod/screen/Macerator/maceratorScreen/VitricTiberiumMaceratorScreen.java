...
public class VitricTiberiumMaceratorScreen extends AbstractContainerScreen<VitricTiberiumMaceratorMenu> {
    ...
    public VitricTiberiumMaceratorScreen(VitricTiberiumMaceratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
