package com.CartersDev.crystechmod.screen.Macerator.maceratorScreen;
...
public class CrystalCoreTiberiumMaceratorScreen extends AbstractContainerScreen<CrystalCoreTiberiumMaceratorMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/tiberium_macerator_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;


    public CrystalCoreTiberiumMaceratorScreen(CrystalCoreTiberiumMaceratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
