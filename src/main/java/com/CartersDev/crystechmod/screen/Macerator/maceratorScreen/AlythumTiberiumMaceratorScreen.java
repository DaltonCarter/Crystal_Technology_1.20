...
public class AlythumTiberiumMaceratorScreen extends AbstractContainerScreen<AlythumTiberiumMaceratorMenu> {
    ...
    public AlythumTiberiumMaceratorScreen(AlythumTiberiumMaceratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
