...
public class TiberiumMaceratorScreen extends AbstractContainerScreen<TiberiumMaceratorMenu> {
    ...
    public TiberiumMaceratorScreen(TiberiumMaceratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
