...
public class VitricKilnScreen extends AbstractContainerScreen<VitricKilnMenu> {
    ...
    public VitricKilnScreen(VitricKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
