package com.CartersDev.crystechmod.screen.PoweredKiln.poweredKilnScreen;
...
public class CrystalCoreKilnScreen extends AbstractContainerScreen<CrystalCoreKilnMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/powered_kiln_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;


    public CrystalCoreKilnScreen(CrystalCoreKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
