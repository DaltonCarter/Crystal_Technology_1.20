...
public class PoweredKilnScreen extends AbstractContainerScreen<PoweredKilnMenu> {
    ...
    public PoweredKilnScreen(PoweredKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
