...
public class AlythumKilnScreen extends AbstractContainerScreen<AlythumKilnMenu> {
    ...
    public AlythumKilnScreen(AlythumKilnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
