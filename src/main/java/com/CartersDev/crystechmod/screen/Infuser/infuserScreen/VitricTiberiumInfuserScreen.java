...
public class VitricTiberiumInfuserScreen extends AbstractContainerScreen<VitricTiberiumInfuserMenu> {
    ...
    public VitricTiberiumInfuserScreen(VitricTiberiumInfuserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        ...
        fluidrenderer = new FluidTankRenderer(24000, true, 16, 39);
    }
