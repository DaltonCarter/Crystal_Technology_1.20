...
public class AlythumTiberiumInfuserScreen extends AbstractContainerScreen<AlythumTiberiumInfuserMenu> {
    ...
    public AlythumTiberiumInfuserScreen(AlythumTiberiumInfuserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
