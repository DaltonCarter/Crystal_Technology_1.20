...
public class TiberiumInfuserScreen extends AbstractContainerScreen<TiberiumInfuserMenu> {
    ...
    public TiberiumInfuserScreen(TiberiumInfuserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
