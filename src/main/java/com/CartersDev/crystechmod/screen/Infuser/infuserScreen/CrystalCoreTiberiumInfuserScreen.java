package com.CartersDev.crystechmod.screen.Infuser.infuserScreen;
...
public class CrystalCoreTiberiumInfuserScreen extends AbstractContainerScreen<CrystalCoreTiberiumInfuserMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/tiberium_infuser_gui.png");

    private EnergyDisplayTooltipArea energyInfoArea;
    private FluidTankRenderer fluidrenderer;


    public CrystalCoreTiberiumInfuserScreen(CrystalCoreTiberiumInfuserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        ...
        fluidrenderer = new FluidTankRenderer(32000, true, 16, 39);
    }
