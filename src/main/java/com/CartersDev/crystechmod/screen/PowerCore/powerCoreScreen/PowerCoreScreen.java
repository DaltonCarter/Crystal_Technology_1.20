package com.CartersDev.crystechmod.screen.PowerCore.powerCoreScreen;
...
public class PowerCoreScreen extends AbstractContainerScreen<PowerCoreMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/power_core_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;


    public PowerCoreScreen(PowerCoreMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
