package com.CartersDev.crystechmod.screen.VitriciumMatrix.vitriciumMatrixScreen;
...
public class VitriciumMatrixScreen extends AbstractContainerScreen<VitriciumMatrixMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CrystalTech.MOD_ID, "textures/gui/vitricium_matrix_gui.png");

    private EnergyDisplayTooltipArea energyInfoArea;
    private FluidTankRenderer fluidrenderer;


    public VitriciumMatrixScreen(VitriciumMatrixMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        ...
        fluidrenderer = new FluidTankRenderer(16000, true, 16, 39);
    }
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        renderFluidTooltipArea(pGuiGraphics, pMouseX, pMouseY, x, y, menu.blockEntity.getFluid(), 80, 10, fluidrenderer);
    }
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        fluidrenderer.render(pGuiGraphics, x + 79, y + 10, menu.blockEntity.getFluid());
    }
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            ...
            guiGraphics.blit(TEXTURE, x + 117, y + 29, 176, 14, k + 1, 16);
        }
    }
