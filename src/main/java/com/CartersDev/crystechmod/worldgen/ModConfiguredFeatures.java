...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?,?>> CT_MOLTEN_ABOREUS_KEY = registerKey("ct_molten_aboreus");
    public static final ResourceKey<ConfiguredFeature<?,?>> CT_MOLTEN_RIPARIUS_KEY = registerKey("ct_molten_riparius");
    public static final ResourceKey<ConfiguredFeature<?,?>> CT_MOLTEN_VINIFERA_KEY = registerKey("ct_molten_vinifera");
    public static final ResourceKey<ConfiguredFeature<?,?>> CT_MOLTEN_CRUENTUS_KEY = registerKey("ct_molten_cruentus");
...
//Misc Overworld:
        ...
        register(context, CT_MOLTEN_ABOREUS_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.MOLTEN_PURPLE_TIBERIUM_BLOCK.get()), BlockPredicate.matchesBlocks(List.of(Blocks.WATER, ModBlocks.TIBERIUM_WATER_BLOCK.get(), Blocks.MUD, ModBlocks.SEEDED_RED_ZONE_DIRT.get())), UniformInt.of(4, 4), 4));
        register(context, CT_MOLTEN_RIPARIUS_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.MOLTEN_TIBERIUM_BLOCK.get()), BlockPredicate.matchesBlocks(List.of(Blocks.WATER, ModBlocks.TIBERIUM_WATER_BLOCK.get(), Blocks.MUD, ModBlocks.SEEDED_RED_ZONE_DIRT.get())), UniformInt.of(4, 4), 4));
        register(context, CT_MOLTEN_VINIFERA_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.MOLTEN_BLUE_TIBERIUM_BLOCK.get()), BlockPredicate.matchesBlocks(List.of(Blocks.WATER, ModBlocks.TIBERIUM_WATER_BLOCK.get(), Blocks.MUD, ModBlocks.SEEDED_RED_ZONE_DIRT.get())), UniformInt.of(4, 4), 4));
        register(context, CT_MOLTEN_CRUENTUS_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.MOLTEN_RED_TIBERIUM_BLOCK.get()), BlockPredicate.matchesBlocks(List.of(Blocks.WATER, ModBlocks.TIBERIUM_WATER_BLOCK.get(), Blocks.MUD, ModBlocks.SEEDED_RED_ZONE_DIRT.get())), UniformInt.of(4, 4), 4));
        ...
        register(context, CT_TIBERIUM_SOIL_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.TIBERIUM_SOIL.get()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, ModBlocks.YELLOW_ZONE_SAND.get(), ModBlocks.YZ_SANDSTONE.get(), ModBlocks.YELLOW_ZONE_CRACKED_DIRT.get(), ModBlocks.SEEDED_YELLOW_ZONE_CRACKED_DIRT.get(), Blocks.TERRACOTTA, Blocks.YELLOW_TERRACOTTA, Blocks.WHITE_TERRACOTTA, Blocks.BROWN_TERRACOTTA, Blocks.ORANGE_TERRACOTTA, Blocks.RED_TERRACOTTA, ModBlocks.INFESTED_COBBLE.get(), ModBlocks.INFESTED_STONE.get(), ModBlocks.INFESTED_GRANITE.get(), ModBlocks.INFESTED_DIORITE.get(), ModBlocks.INFESTED_ANDESITE.get(), Blocks.PODZOL, Blocks.MUD, ModBlocks.RED_ZONE_DIRT.get(), ModBlocks.SEEDED_RED_ZONE_DIRT.get(), ModBlocks.RED_ZONE_SAND.get(), ModBlocks.RZ_SANDSTONE.get())), UniformInt.of(1, 5), 2));
        register(context, CT_ICHOR_SOIL_KEY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.ICHOR_SOIL.get()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, ModBlocks.YELLOW_ZONE_SAND.get(), ModBlocks.YZ_SANDSTONE.get(), ModBlocks.YELLOW_ZONE_CRACKED_DIRT.get(), ModBlocks.SEEDED_YELLOW_ZONE_CRACKED_DIRT.get(), Blocks.TERRACOTTA, Blocks.YELLOW_TERRACOTTA, Blocks.WHITE_TERRACOTTA, Blocks.BROWN_TERRACOTTA, Blocks.ORANGE_TERRACOTTA, Blocks.RED_TERRACOTTA, ModBlocks.INFESTED_COBBLE.get(), ModBlocks.INFESTED_STONE.get(), ModBlocks.RED_ZONE_DIRT.get(), ModBlocks.SEEDED_RED_ZONE_DIRT.get(), ModBlocks.RED_ZONE_SAND.get(), ModBlocks.RZ_SANDSTONE.get())), UniformInt.of(1, 3), 1));
