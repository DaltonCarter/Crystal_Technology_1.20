...
public class ModBiomes {
    ...
    protected static int calculateWaterColor(float pTemperature) {
        float $$1 = pTemperature / 3.0F;
        $$1 = Mth.clamp($$1, -1.0F, 1.0F);
        return Mth.hsvToRgb(0.62222224F - $$1 * 0.05F, 0.5F + $$1 * 0.1F, 1.0F);
    }
...
//    //Red Zone:
    ...
    public static final ResourceKey<Biome> CRYSTALLINE_PLATEAU = register("crystalline_plateau");
...
public static void bootstrap(BootstapContext<Biome> context){
    ...
    //Red Zone:
    context.register(ASHLANDS, ashlands(context));
    context.register(BROODING_LANDS, broodingLands(context));
    context.register(WASTELAND, wasteland(context));
    context.register(WASTELAND_HILLS, wastelandHills(context));
    context.register(SCORCHED_DESERT, scorchedDesert(context));
    context.register(SCORCHED_HILLS, scorchedHills(context));
    context.register(RED_AND_BLUE_ZONE_BORDER, redAndBlueZoneBorder(context));
    context.register(ICHOR_MARSH, ichorMarsh(context));
    context.register(ABYSSAL_MARSH, abyssalMarsh(context));
    context.register(DEAD_PLAINS, deadPlains(context));
    context.register(RED_ZONE_SHORE, redZoneShore(context));
    context.register(RED_ZONE_RIVER, redZoneRiver(context));

    context.register(FIRESTORM_PLAINS, firestormPlains(context));
    context.register(CRYSTALLINE_PLATEAU, crystallinePlateau(context));
    context.register(CRYSTALLINE_HILLS, crystallineHills(context));
    context.register(DEAD_ZONE, deadZone(context));
    context.register(TIBERIAN_WASTES, tiberianWastes(context));
    context.register(PLAGUED_WOODS, plaguedWoods(context));
    context.register(ICHOR_BOG, ichorBog(context));
...
public static Biome calidianMarsh(BootstapContext<Biome> context) {
    ...
    return (new Biome.BiomeBuilder())
            ...
            .downfall(0.9F)
            .specialEffects((new BiomeSpecialEffects.Builder())
                    .waterColor(calculateWaterColor(0.8F))
                    .waterFogColor(calculateWaterColor(0.8F))
                    .fogColor(12638463)
    ...
    public static Biome foothills(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, MiscOverworldPlacements.DISK_GRAVEL);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, MiscOverworldPlacements.DISK_GRASS);
        ...
        return (new Biome.BiomeBuilder())
                ...
                .downfall(0.3F)
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(0.2F))
                        .waterFogColor(calculateWaterColor(0.2F))
                        .fogColor(12638463)
    ...
    public static Biome primalJungle(BootstapContext<Biome> context) {
        ...
        return (new Biome.BiomeBuilder())
                ...
                .downfall(0.9F)
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(0.95F))
                        .waterFogColor(calculateWaterColor(0.95F))
                        .fogColor(12638463)
    ...
    public static Biome blueAndYellowZoneBorder(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.VITRIC_BLOOM_PLACED_KEY);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_SEEDED_DIRT_PLACED_KEY);
        ...
        public static Biome burningHills(BootstapContext<Biome> context) {
            ...
            return new Biome.BiomeBuilder()
                    ...
                    .mobSpawnSettings(spawnBuilder.build())
                    .specialEffects((new BiomeSpecialEffects.Builder())
                            .waterColor(calculateWaterColor(1.5F))
                            .waterFogColor(calculateWaterColor(1.5F))
                            .skyColor(0xFF8585)
                            .grassColorOverride(0xFF0A0A)
                            .foliageColorOverride(0xA30000)
                            .fogColor(0xFF4747)
    ...
    public static Biome deadForest (BootstapContext<Biome> context) {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_SHEEP.get(), 12, 4, 4));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_COW.get(), 10, 4, 4));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.RHINO.get(), 6, 3, 5));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.VITRIC_ROSE_PLACED_KEY);
    ...
    public static Biome tiberianDesert (BootstapContext<Biome> context) {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_SHEEP.get(), 8, 4, 4));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_COW.get(), 10, 4, 4));
        ...
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(2.0F))
                        .waterFogColor(calculateWaterColor(2.0F))
    ...
    public static Biome tiberianDesertHills (BootstapContext<Biome> context) {
        ...
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        BiomeDefaultFeatures.monsters(spawnBuilder, 100, 25, 100, false);
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.CHICKEN, 10, 1, 4));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_YELLOW_ZONE_SAND_PLACED_KEY);
    ...
    public static Biome lostSteppes (BootstapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(0.1F))
                        .waterFogColor(calculateWaterColor(0.1F))
    ...
    public static Biome dryValley (BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_STONE_LARGE_COLUMN_PLACED_KEY);
    ...
    public static Biome redAndYellowZoneBorder (BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VINIFERA_STONE_CLUMP_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_STONE_CLUMP_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_STONE_LARGE_COLUMN_PLACED_KEY);
    ...
    public static Biome tiberianTaiga (BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HEAVY_PLAGUED_PLACED_KEY);
        ...
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(0.4F))
                        .waterFogColor(calculateWaterColor(0.4F))
    ...
    public static Biome tiberianSwamp(BootstapContext<Biome> context) {
        ...
        return (new Biome.BiomeBuilder())
                ...
                .mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(calculateWaterColor(0.9F))
                        .waterFogColor(calculateWaterColor(0.9F))
    ...
    public static Biome ashlands (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        BiomeDefaultFeatures.addFossilDecoration(biomeBuilder);
        vitricExpanseRZGeneration(biomeBuilder);


        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        ModBiomeDefaultFeatures.addVitricOreVariety(biomeBuilder);
        ModBiomeDefaultFeatures.addRZSoftDisks(biomeBuilder);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ICHOR_SOIL_PLACED_KEY);
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(0x353A47)
                        .waterFogColor(0x353A47)
                        .skyColor(0x353A47)
                        .grassColorOverride(0x353A47)
                        .foliageColorOverride(0x353A47)
                        .fogColor(0x353A47)
                        .ambientMoodSound(new AmbientMoodSettings(ModSounds.RED_ZONE_AMBIENT.getHolder().get(), 6000, 8, 2.0D))
                        .ambientParticle(new AmbientParticleSettings(ParticleTypes.ASH, 0.0008925F))
                        .backgroundMusic(Musics.createGameMusic(ModSounds.VITRIC_EXPANSE_MUSIC.getHolder().get())).build())
                .build();
    }

    public static Biome redZoneShore (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome redZoneRiver (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome scorchedDesert (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome scorchedHills (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome wasteland (BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_STONE_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_STONE_CLUMP_PLACED_KEY);
    ...
    public static Biome wastelandHills (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_STONE_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_STONE_CLUMP_PLACED_KEY);
    ...
    public static Biome oldWarZone (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome redAndBlueZoneBorder (BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome ichorMarsh(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1, 1));
        BiomeDefaultFeatures.monsters(spawnBuilder, 100, 25, 100, false);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VIT_WATER_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_MOLTEN_ABOREUS_PLACED_KEY);
    ...
    public static Biome ichorBog(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1, 1));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VIT_WATER_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_MOLTEN_VINIFERA_PLACED_KEY);


        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ICHOR_SOIL_PLACED_KEY);

        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_STONE_SMALL_COLUMN_PLACED_KEY);
    ...
    public static Biome abyssalMarsh(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1, 1));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VIT_WATER_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_MOLTEN_CRUENTUS_PLACED_KEY);

        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ICHOR_SOIL_PLACED_KEY);

        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_CRYSTAL_SMALL_COLUMN_PLACED_KEY);
    ...
    public static Biome tiberianWastes(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1, 1));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VIT_WATER_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_MOLTEN_RIPARIUS_PLACED_KEY);
    ...
    public static Biome deadZone(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1, 1));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ICHOR_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_RED_ZONE_SAND_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_RED_ZONE_DIRT_PLACED_KEY);


        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VINIFERA_CRYSTAL_LARGE_COLUMN_PLACED_KEY);
        ...
        return (new Biome.BiomeBuilder())
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        ...
                        .fogColor(0x353A47)
                        .ambientMoodSound(new AmbientMoodSettings(ModSounds.RED_ZONE_AMBIENT.getHolder().get(), 6000, 8, 2.0D))
                        .ambientParticle(new AmbientParticleSettings(ParticleTypes.PORTAL, 0.0008925F))
                        .backgroundMusic(Musics.createGameMusic(ModSounds.VITRIC_EXPANSE_MUSIC.getHolder().get())).build())
                .build();
    }

    public static Biome deadPlains(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_SHEEP.get(), 12, 4, 4));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.VITRIC_COW.get(), 10, 4, 4));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.RHINO.get(), 8, 3, 5));
    ...
    public static Biome firestormPlains(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.plainsSpawns(spawnBuilder);
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        BiomeDefaultFeatures.monsters(spawnBuilder, 100, 25, 100, false);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_TIBERIUM_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ICHOR_SOIL_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_MAGMA_PLACED_KEY);
    ...
    public static Biome broodingLands(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_CRYSTAL_PLACED_KEY);
    ...
    public static Biome crystallineHills(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_CRUENTUS_CRYSTAL_LARGE_COLUMN_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_ABOREUS_CRYSTAL_LARGE_COLUMN_PLACED_KEY);
    ...
    public static Biome crystallinePlateau(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_RIPARIUS_CRYSTAL_LARGE_COLUMN_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.CT_VINIFERA_CRYSTAL_LARGE_COLUMN_PLACED_KEY);
