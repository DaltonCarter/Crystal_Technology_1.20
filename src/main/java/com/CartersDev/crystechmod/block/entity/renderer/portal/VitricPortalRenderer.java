package com.CartersDev.crystechmod.block.entity.renderer.portal;
...
public class VitricPortalRenderer<T extends VitricPortalBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public VitricPortalRenderer(BlockEntityRendererProvider.Context pContext) {
    }
