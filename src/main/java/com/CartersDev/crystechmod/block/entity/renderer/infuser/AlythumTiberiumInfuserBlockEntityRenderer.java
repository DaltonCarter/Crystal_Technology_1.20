...
public class AlythumTiberiumInfuserBlockEntityRenderer implements BlockEntityRenderer<AlythumTiberiumInfuserBlockEntity> {
    public AlythumTiberiumInfuserBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(AlythumTiberiumInfuserBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource,
