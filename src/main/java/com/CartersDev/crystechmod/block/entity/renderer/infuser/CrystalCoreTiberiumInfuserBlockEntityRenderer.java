...
public class CrystalCoreTiberiumInfuserBlockEntityRenderer implements BlockEntityRenderer<CrystalCoreTiberiumInfuserBlockEntity> {
    public CrystalCoreTiberiumInfuserBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(CrystalCoreTiberiumInfuserBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource,
