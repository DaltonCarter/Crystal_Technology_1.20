...
public class CrystalCoreKilnBlockEntityRenderer implements BlockEntityRenderer<CrystalCoreKilnBlockEntity> {

    public CrystalCoreKilnBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(CrystalCoreKilnBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
