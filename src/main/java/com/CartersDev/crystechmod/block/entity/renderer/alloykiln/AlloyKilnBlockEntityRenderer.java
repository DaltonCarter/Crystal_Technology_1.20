...
public class AlloyKilnBlockEntityRenderer implements BlockEntityRenderer<AlloyKilnBlockEntity> {

    public AlloyKilnBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(AlloyKilnBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
