...
public class PoweredKilnBlockEntityRenderer implements BlockEntityRenderer<PoweredKilnBlockEntity> {

    public PoweredKilnBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(PoweredKilnBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
