...
public class TiberiumMaceratorBlockEntityRenderer implements BlockEntityRenderer<TiberiumMaceratorBlockEntity> {

    public TiberiumMaceratorBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(TiberiumMaceratorBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
