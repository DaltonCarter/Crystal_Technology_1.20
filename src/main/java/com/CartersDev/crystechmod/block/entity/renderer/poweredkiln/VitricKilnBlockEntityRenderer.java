...
public class VitricKilnBlockEntityRenderer implements BlockEntityRenderer<VitricKilnBlockEntity> {

    public VitricKilnBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(VitricKilnBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
