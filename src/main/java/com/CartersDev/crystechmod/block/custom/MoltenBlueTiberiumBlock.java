...
public class MoltenBlueTiberiumBlock extends LiquidBlock {
    ...
    public MoltenBlueTiberiumBlock(Supplier<? extends FlowingFluid> pFluid, Properties pProperties, int burnTime, float damage) {
