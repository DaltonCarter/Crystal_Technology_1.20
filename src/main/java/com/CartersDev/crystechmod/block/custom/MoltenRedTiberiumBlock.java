...
public class MoltenRedTiberiumBlock extends LiquidBlock {
    ...
    public MoltenRedTiberiumBlock(Supplier<? extends FlowingFluid> pFluid, Properties pProperties, int burnTime, float damage) {
