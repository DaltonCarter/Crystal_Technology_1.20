...
public class MoltenPurpleTiberiumBlock extends LiquidBlock {
    ...
    public MoltenPurpleTiberiumBlock(Supplier<? extends FlowingFluid> pFluid, Properties pProperties, int burnTime, float damage) {
