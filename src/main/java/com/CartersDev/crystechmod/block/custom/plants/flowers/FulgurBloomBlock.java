...
public class FulgurBloomBlock extends FlowerBlock implements BonemealableBlock {
    ...
    public void animateTick(BlockState pState, Level pLevel, BlockPos pPos, RandomSource pRandom) {
        ...
        if (chance < pRandom.nextFloat()) {
            pLevel.addParticle(ModParticles.CHARGE_PARTICLES.get(), pPos.getX() + pRandom.nextDouble(),
