...
public class FlowerofLifeBlock extends FlowerBlock implements BonemealableBlock {
    ...
    public void animateTick(BlockState pState, Level pLevel, BlockPos pPos, RandomSource pRandom) {
        ...
        if (chance < pRandom.nextFloat()) {
            pLevel.addParticle(ModParticles.PROTOCULTURE_PARTICLES.get(), pPos.getX() + pRandom.nextDouble(),
