...
public class AdvancedVitriciumResistanceEffect extends MobEffect {
    public AdvancedVitriciumResistanceEffect(MobEffectCategory pCategory, int pColor) {
    ...
    public void applyEffectTick(LivingEntity pLivingEntity, int pAmplifier) {
        ...
        if(pLivingEntity.hasEffect(ModEffects.INITIAL_VITRICIUM_INFECTION_EFFECT.get()) ||
                pLivingEntity.hasEffect(ModEffects.SERIOUS_VITRICIUM_INFECTION_EFFECT.get()) ||
                pLivingEntity.hasEffect(ModEffects.CRITICAL_VITRICIUM_INFECTION_EFFECT.get()))
        {
